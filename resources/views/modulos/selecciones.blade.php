                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 gap-x-2 gap-y-6 transition-all">
                    ...
                    <div class="max-w-sm bg-white transform ease-in duration-150 hover:scale-105">
                        ...
                        <div class="p-2">
                            ...
                            <div class="container-{{str_replace(' ', '', $seleccion->nombre)}} hidden rounded-lg shadow-lg p-3">
                                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400 text-center">{{$seleccion->descripcion}}</p>
                            </div>
                        </div>
                    </div>
                    @endforeach
