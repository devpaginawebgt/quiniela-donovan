...
<nav class="fixed bottom-0 left-0 right-0 z-50 bg-complementary-primary border-t border-complementary-light">
            ...
            @if (request()->routeIs('web.inicio'))
                <span class="bg-secondary rounded-full px-3 py-1 flex items-center gap-1 text-complementary-primary">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <path d="m12 5.432 8.159 8.159c.03.03.06.058.091.086v6.198c0 1.035-.84 1.875-1.875 1.875H15a.75.75 0 0 1-.75-.75v-4.5a.75.75 0 0 0-.75-.75h-3a.75.75 0 0 0-.75.75V21a.75.75 0 0 1-.75.75H5.625a1.875 1.875 0 0 1-1.875-1.875v-6.198a1.05 1.05 0 0 0 .091-.086L12 5.432Z"/>
                    </svg>
                </span>
                Inicio
            @else
