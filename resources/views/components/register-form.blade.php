...
>
    ...
    <div class="mt-2 md:col-span-2">
        <button
            type="submit"
            class="w-full bg-red-600/80 text-light font-bold rounded-full text-lg px-6 py-3.5 hover:brightness-[1.1] focus:ring-3 focus:ring-white flex items-center justify-center gap-2"
        >
